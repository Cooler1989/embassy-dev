...
use embassy_rp::pio::{
    Common as PioCommon, Config as ConfigPio, Direction as PioPinDirection, Instance as PioInstance, Irq as PioIrq,
...
impl<'a, PioRx: PioInstance, const SM_RX: usize, PioTx: PioInstance, const SM_TX: usize>
...
impl<'a, PioRx: PioInstance, const SM_RX: usize, PioTx: PioInstance, const SM_TX: usize> OpenThermSlave
    for PioOpenTherm<'a, PioRx, SM_RX, PioTx, SM_TX>
{
    async fn wait_reception_run_callback_respond<F, ErrorSpecific>(
        &mut self,
        callback: F,
    ) -> Result<(), <PioOpenTherm<'a, PioRx, SM_RX, PioTx, SM_TX> as OpenThermBus>::Error>
    where
...
impl<'a, PioRx: PioInstance, const SM_RX: usize, PioTx: PioInstance, const SM_TX: usize> OpenThermBus
    for PioOpenTherm<'a, PioRx, SM_RX, PioTx, SM_TX>
{
    type Error = OtError;
    ...
    async fn transact(
        ...
        <PioOpenTherm<'a, PioRx, SM_RX, PioTx, SM_TX> as OpenThermBus>::Output,
        <PioOpenTherm<'a, PioRx, SM_RX, PioTx, SM_TX> as OpenThermBus>::Error,
    > {
